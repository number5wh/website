...
// http://order.game593.net/app_jtpay_notify.php?p1_usercode=10210330&p2_order=20170307122956&p3_money=0.01&p4_status=1&p5_jtpayorder=20170307122957124056&p6_paymethod=10&p8_charset=UTF-8&p9_signtype=MD5&p10_sign=6FB4D351EEBE7C107731DB1AA289A0A2

// {"p1_usercode":"10210330","p2_order":"20170307122956","p3_money":"0.01","p4_status":"1","p5_jtpayorder":"20170307122957124056","p6_paymethod":"10","p8_charset":"UTF-8","p9_signtype":"MD5","p10_sign":"6FB4D351EEBE7C107731DB1AA289A0A2"}
...
// $md5info_paramet = $_REQUEST['p1_usercode']."&".$_REQUEST['p2_order']."&".$_REQUEST['p3_money']."&".$_REQUEST['p4_status']."&".$_REQUEST['p5_jtpayorder']."&".$_REQUEST['p6_paymethod']."&".$_REQUEST['p8_charset']."&".$_REQUEST['p9_signtype']."&".$signmsg;
