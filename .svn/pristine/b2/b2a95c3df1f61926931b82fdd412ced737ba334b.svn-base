...
class GamePayClassAction extends PageBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->display($this->arrConfig['skin'] . '/Yunwei/GamePayClassList.html');
    }
    ...
    public function getPagerClassList()
    {
        ...
        $arrTags = array('skin' => $this->arrConfig['skin'], 'Page' => $arrResult['Page'], 'ClassList' => $arrResult['ClassList']);
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Yunwei/GamePayClassListPage.html');
    ...
    public function showEdit()
    {
        ...
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Yunwei/GamePayClassEdit.html');
        $html=str_replace("</script>","<\/script>",str_replace("\r\n",'',$html));
        echo $html;
    }
