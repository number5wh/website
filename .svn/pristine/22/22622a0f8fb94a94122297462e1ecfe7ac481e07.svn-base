...
class CashOutAction extends PageBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->display($this->arrConfig['skin'].'/YunYing/CashOutList.html');
    }
    ...
    public function getPagerCashOut($pagesize)
    {
        ...
        $arrParam['fields']=' OrderNo, AccountID, iMoney, AddTime, PayWay, RealName, CardNo, IsDrawback, BankName,status';
    ...
    public function getPagerCashOutList()
    {
        ...
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/YunYing/CashOutListPage.html');
