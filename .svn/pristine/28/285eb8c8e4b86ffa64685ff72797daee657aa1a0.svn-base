...
class GamePayAmountAction extends PageBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->display($this->arrConfig['skin'] . '/Service/GamePayAmountList.html');
    }
...
//        unset($v);
    ...
    public function getList()
    {
        ...
        $arrTags = array('skin' => $this->arrConfig['skin'], 'Page' => $arrResult['Page'], 'AmountList' => $arrResult['AmountList']);
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Service/GamePayAmountList.html');
    ...
    public function showEdit()
    {
        ...
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Service/GamePayAmountEdit.html');
        $html=str_replace("</script>","<\/script>",str_replace("\r\n",'',$html));
        echo $html;
    }
    ...
    {
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Service/GamePayAmountAdd.html');
        $html=str_replace("</script>","<\/script>",str_replace("\r\n",'',$html));
        echo $html;
    }
