...
<body>
            ...
            <div class="detailsRight">
                <div class="commonProblem new">
                    <div class="main">
                        <div class="mainframe">
                            <div class="cBody"> <img src="images/1050/title.jpg" />
                                ...
                                <div class="cContent" id="con_1">
                                    <!--游戏简介-->
                                    <div class="cCbody"> “欢乐至尊”是浙江一带的传统游戏，尤其在温州盛行。规则简单易懂，游戏节奏快速、过程刺激，游戏分顺门、对门、倒门、庄四个主门和角、桥两个辅门，每门发两张牌，无论几个人参加游戏，每一门都发两张牌，同时玩家可以按自己的意向选择压哪一门。游戏由2张牌相加的点数来比较大小。</div>
                                    <img src="images/1050/screen.jpg" /> </div>
