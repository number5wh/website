...
class GamePayChannelAction extends PageBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->display($this->arrConfig['skin'] . '/Yunwei/GamePayChannelList.html');
    }
...
//        die;
    ...
    public function getList()
    {
        ...
        $arrTags = array('skin' => $this->arrConfig['skin'], 'Page' => $arrResult['Page'], 'ChannelList' => $arrResult['ChannelList']);
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Yunwei/GamePayChannelListPage.html');
    ...
    public function showEdit()
    {
        ...
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Yunwei/GamePayChannelEdit.html');
        $html=str_replace("</script>","<\/script>",str_replace("\r\n",'',$html));
        echo $html;
    }
    ...
    {
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Yunwei/GamePayChannelAdd.html');
        $html=str_replace("</script>","<\/script>",str_replace("\r\n",'',$html));
        echo $html;
    }
