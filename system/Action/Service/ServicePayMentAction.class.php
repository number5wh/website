...
class ServicePayMentAction extends PageBase
{
    ...
    function index(){
        ...
        $this->smarty->display($this->arrConfig['skin'].'/Service/ServicePayMentIndex.html');
    }
    ...
    function ExchangeList()
    {
            ...
            ($endTime != '' && !preg_match($pattern, $endTime)) || ($startTime > $endTime))
        {
            ...
            if($iStatus != '' && ($iStatus == 1 || $iStatus == 3)){
        ...
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Service/ServicePayMentPage.html');
    ...
    function getOperateVerifyPage()
    {
        ...
        Utility::assign($this->smarty,$arrTags);
        $html = $this->smarty->fetch($this->arrConfig['skin'].'/Service/ExchangePayMentDetail.html');
        echo $html;
    }
    ...
    function doOperateVerify()
    {
        ...
        {
            $objbank =new BankBLL();
            $ret = $objbank->DrawBackFinish($iPId,$iRoleId);
            echo 1;
        }
        else
        {
