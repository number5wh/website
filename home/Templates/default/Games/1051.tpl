...
<body>
            ...
            <div class="detailsRight">
                <div class="commonProblem new">
                    <div class="main">
                        <div class="mainframe">
                            <div class="cBody"> <img src="images/1051/title.jpg" />
                                ...
                                <div class="cContent" id="con_1">
                                    <!--游戏简介-->
                                    <div class="cCbody">“火拼两张”是一款在民间广为流传的牌类游戏。简单说来，只需几名朋友聚在一起，每人每局随机发两张牌，一决高下，最终一名玩家最终胜出。游戏规则相当简单，但是游戏过程耐玩刺激，比拼是智慧技巧，更是胆识。</div>
                                    <img src="images/1051/screen.jpg" /> </div>
